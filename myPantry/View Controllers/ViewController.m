...
-(void)loadData{
    // Form the query.
    NSString *query = @"select * from shopInfo order by priority desc;";
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSInteger indexOfFoodName = [self.dbManager.arrColumnNames indexOfObject:@"foodname"];
    NSInteger indexOfPriority = [self.dbManager.arrColumnNames indexOfObject:@"priority"];
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"Priority: %@", [[self.arrPeopleInfo objectAtIndex:indexPath.row] objectAtIndex:indexOfPriority]];
...
-(void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        // Prepare the query.
        NSString *query = [NSString stringWithFormat:@"delete from shopInfo where shopInfoID=%d", recordIDToDelete];
